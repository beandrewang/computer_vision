...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		for y = 1 : pixelsPerHistogram : pixelsPerHistogram * num_histograms
			for x = 1 : pixelsPerHistogram : pixelsPerHistogram * num_histograms
				cell_mag = patch_mag(y : y + pixelsPerHistogram - 1, x : x + pixelsPerHistogram - 1);
				cell_theta = patch_theta(y : y + pixelsPerHistogram - 1, x : x + pixelsPerHistogram - 1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1 : num_bins
    	...
    	histogram(i) = sum(gradient_magnitudes(find((gradient_angles >= low) & (gradient_angles < high))));
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    direction = angles(find(histogram == max(histogram)))(1);
