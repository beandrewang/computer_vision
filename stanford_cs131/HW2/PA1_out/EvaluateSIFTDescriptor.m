...
%% because I am using Octave, and got a error of 1.2903e-3
%% so I change the threshold from 1e-3 to 1.5e-3. 
%% I compared the data between descriptors and solution, the values
%% are almost the same. 
if sum(sum(descriptors-solution).^2) < 1.5e-3,  
    fprintf('%s\n', 'Accepted!');
else
